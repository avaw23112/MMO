...
public class EntityController : MonoBehaviour, IEntityNotify
{
    ...
    void Start()
    {
        ...
        {
            //注册事件接收者
            EntityManager.Instance.RegisterEntityChangerNotify(entity.entityId, this);
    ...
    [SerializeField] bool testRide = false;
    public void SetRidePotision(Vector3 position)
    {
        this.anim.transform.position = position - (this.rideBone.position - this.anim.transform.position);
    }
