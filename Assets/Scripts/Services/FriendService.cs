...
namespace Assets.Scripts.Services
{
    class FriendService : Singleton<FriendService>, IDisposable
    {
        ...
        {
            MessageDistributer.Instance.Subscribe<FriendAddRequest>(this.OnFriendAddRequest); //好友添加请求
        ...
        private void OnFriendAddResponse(object sender, FriendAddResponse message)
        {
            ...
            else /*if(!GameObjectManager.Instance.character.IsCurrentPlayer)*/
        ...
        private void OnFriendRemove(object sender, FriendRemoveResponse messsage)
        {
            if (messsage.Result == Result.Success)
