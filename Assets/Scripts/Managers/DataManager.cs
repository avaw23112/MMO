...
public class DataManager : Singleton<DataManager>
{
    ...
    {
        this.DataPath = "Data/";
        this.ServeDataPath = "../Server/GameServer/GameServer/bin/Debug/Data/";
    ...
    public void SaveTeleporters()
    {
        ...
        File.WriteAllText(this.ServeDataPath + "TeleporterDefine.txt", json);
    }
    ...
    public void SaveSpawnPoints()
    {
        ...
        File.WriteAllText(this.ServeDataPath + "SpawnPointDefine.txt", json);
    }
