...
public class QuestManager : Singleton<QuestManager>
{
    ...
    private void InitQuests()
    {
        ...
        {
            this.AddNpcQuest(kv.Value.Define.AcceptNPC, kv.Value); //接取NPC
            this.AddNpcQuest(kv.Value.Define.SubmitNPC, kv.Value); //提交NPC
        }
    }
